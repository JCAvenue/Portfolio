...
const TechnologyStack = () => {
  ...
  return (
    <div className="flex justify-center bg-blue-50 lg-h-[300px]">
      <div className="container mx-auto px-8 mb-10">
        <div className="mt-10 text-center text-2xl font-semibold mb-10 ">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12  mx-auto gap-2">
          {tech_items.map((item) => {
            return (
              <div
                key={item.alt_name}
